...
// Debug endpoint to verify shouldUsePrisma type
router.get("/debug/prisma-check", (_req, res) => {
  res.json({
    shouldUsePrisma: shouldUsePrisma,
    type: typeof shouldUsePrisma,
    isBoolean: typeof shouldUsePrisma === 'boolean',
    isFunction: typeof shouldUsePrisma === 'function',
    value: String(shouldUsePrisma),
    timestamp: new Date().toISOString(),
